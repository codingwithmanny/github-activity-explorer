 ...
 *
 */
test('Renders <Graph /> Loading No History', () => {
  const tree = renderer.create(<Graph loading={true} />).toJSON();
 ...
 *
 */
test('Renders <Graph /> Not Loading No History', () => {
  const tree = renderer.create(<Graph loading={false} />).toJSON();
  expect(tree).toMatchSnapshot();
});
 ...
 *
 */
test('Renders <Graph /> Not Loading With History', () => {
  const tree = renderer
    .create(
      <Graph
        loading={false}
